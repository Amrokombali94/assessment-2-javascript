...
console.log(canWeDeliverTwo(8529888))
...
console.log(firstTitle.replace('15', '10'))
...
let secondDesc = deals[1].desc

console.log(secondDesc.replace('March', 'April'))